...
class SeatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seat" do
    assert_difference("Seat.count") do
      post seats_url, params: { seat: { attendee_id: @seat.attendee_id, event_id: @seat.event_id, no: @seat.no } }
    end
  ...
  test "should update seat" do
    patch seat_url(@seat), params: { seat: { attendee_id: @seat.attendee_id, event_id: @seat.event_id, no: @seat.no } }
